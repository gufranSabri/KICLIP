ROOT=./
CKPT=./basetraining/B2N_k400_scar
...
CUDA_VISIBLE_DEVICES=0 python test_b2n.py \
    --cfg config_files/Kinetics/SCAR_vitb16_8x16_STAdapter_K400.yaml \
...
CUDA_VISIBLE_DEVICES=0 python test_b2n.py \
    --cfg configs_files/Kinetics/SCAR_vitb16_8x16_STAdapter_K400.yaml \
    --opts DATA.PATH_TO_DATA_DIR ./zs_label_db/B2N_k400 \
    TRAIN_FILE $TRAIN_FILE \
    VAL_FILE $VAL_FILE \
    TEST_FILE $TEST_FILE \
