...
CUDA_VISIBLE_DEVICES=0 python3 train_b2n.py \
  ...
  TRAIN.ENABLE True \
  OUTPUT_DIR ./basetraining/B2N_k400_scar \
  TRAIN.BATCH_SIZE 4 \
  TEST.BATCH_SIZE 4 \
